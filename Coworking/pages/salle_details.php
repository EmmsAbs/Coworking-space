<?php
    ...
    $salle = null;
    if (isset($_GET['idd'])) {
          $salle = Salle::getSalleById(intval($_GET['idd']));
    }
...
<div class="bg-gradient-to-r mx-auto from-blue-50 to-gray-100 min-h-screen flex items-center justify-center p-6">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-3xl p-8">
        ...
        <div class="flex justify-between mt-8">
            <a href="../pages/reservation.php?id=<?= $salle->getId()?>"><button class="bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-xl focus:outline-none focus:ring-4 focus:ring-green-300 font-semibold">
                Réserver
            </button></a>
            <a href="../pages/workspace.php"><button class="bg-gray-500 hover:bg-gray-600 text-white py-3 px-6 rounded-xl focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold">
                Retour
            </button></a>
        </div>
    </div>
