            ...
            if($type){
                if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
                    ...
                    if (move_uploaded_file($imageTmpPath, $newImagePath)) {
                        ...
                        $salle = new Salle(0, $nom, $description, $capacite, $newImagePath, $price, $type);
                ...
                if($res){
                    ...
                    window.location.href = '../pages/salle_add.php'; 
                    </script>";
                    exit;
                }
            }
...
?>
    <div class="container mx-auto px-6 py-10">
        <!-- Header -->
        <h1 class="text-4xl font-extrabold text-center text-gray-800 mb-10">Ajouter une salle</h1>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-10">
            ...
            <form action="salle_add.php" method="POST" class="space-y-6" enctype="multipart/form-data">
                <div>
                    <label for="nom" class="block text-sm font-medium text-gray-700">Nom de la Salle</label>
                    <input type="text" id="nom" name="nom" required placeholder="Salle A" class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div>
                    ...
                    <select name="type" id="type" required class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        <option value="" disabled selected>Sélectionner le type de la salle</option>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" placeholder="Décrivez la salle"></textarea>
                </div>

                <div>
                    <label for="capacite" class="block text-sm font-medium text-gray-700">Capacité</label>
                    <input type="number" id="capacite" name="capacite" min ="0" step="10" required placeholder="50" class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>

                <div>
                    <label for="price" class="block text-sm font-medium text-gray-700">Prix horaire (DH)</label>
                    <input type="number" id="price" name="price" step="25.00" min ="0" required placeholder="Entrez le prix" class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="flex space-x-4 items-center">
                    ...
                    <div>
                        ...
                        <select id="selected-equipements" multiple size="6" class="w-full p-3 border border-gray-300 rounded-md"></select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="file" id="image" name="image" accept="image/*" required class="w-full mt-1 p-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                


                <button type="submit" name="add_salle" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300">
                    Ajouter la Salle
                </button>
            </form>
        </div>
